...
class Vector3 {
    ...
    static angleBetween(v1, v2) {
      ...
      // calulate magnitude of v1 and v2
      let mag1 = Math.sqrt((v1.elements[0] ** 2) + (v1.elements[1] ** 2) + (v1.elements[2] ** 2));
      let mag2 = Math.sqrt((v2.elements[0] ** 2) + (v2.elements[1] ** 2) + (v2.elements[2] ** 2));

      // calculate dividend (dot between v1 and v2)
      let dividend = Vector3.dot(v1,v2);
      
      // calculate divisor (mag1 times mag2)
      let divisor = mag1 * mag2;

      // calculate angle
      let angle = (Math.acos(dividend / divisor)) * (180 / Math.PI);
      return angle;
    }
    ...
    static areaTriangle(v1, v2) {
      ...
      let x = v3.elements[0] ** 2;
      let y = v3.elements[1] ** 2;
      let z = v3.elements[2] ** 2;

      // calculate the area (find magnitude)
      let final_area = Math.sqrt(x+y+z);
    ...
    magnitude() {
        ...
        let x_squared = this.elements[0] ** 2;
        let y_squared = this.elements[1] ** 2;
        let z_squared = this.elements[2] ** 2;
        m = Math.sqrt((x_squared + y_squared + z_squared));
        // Don't delete the return statement.
        return m;
    };
